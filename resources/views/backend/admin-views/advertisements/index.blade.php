...
{{--                    @can('create-permission-category')--}}
                        <a href="{{ route('advertisements.create') }}" class="rounded-circle text-white border-5 text-light f-s-22 btn position-absolute end-0 me-4">
                    ...
                    <table class="table" id="file-datatable">
                        ...
                        @foreach($advertisements as $advertisement)
                            <tr>
                                ...
                                <td>{!! \Illuminate\Support\Str::words($advertisement->content, 30, '...') ?? '' !!}</td>
                                <td>
                                    <img src="{{ asset($advertisement->banner) }}" alt="" style="height: 60px" />
                                </td>
                                <td>{{ $advertisement->redirect_url ?? '' }}</td>
                                <td>{{ $advertisement->status == 1 ? 'Published' : 'Unpublished' }}</td>
                                <td class="">
{{--                                    @can('edit-permission-category')--}}
                                    <a href="{{ route('advertisements.edit', $advertisement->id) }}" class="btn btn-sm btn-warning" title="Edit">
