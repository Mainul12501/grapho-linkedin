...
{{--                <img src="{{ isset($siteSetting) ? asset($siteSetting->logo) : asset('/frontend/logo/logo-md.svg') }}" class="header-brand-img desktop-logo" style="min-width: 120px" alt="logo">--}}
                <img src="{{ asset('/frontend/likewise.png') }}" class="header-brand-img desktop-logo" style="min-width: 120px" alt="logo">
{{--                <img src="{{ isset($siteSetting) ? asset($siteSetting->logo) : asset('/frontend/logo/logo-md.svg') }}" class="header-brand-img light-logo1" style="min-width: 120px" alt="logo">--}}
                <img src="{{ asset('/frontend/likewise.png') }}" class="header-brand-img light-logo1" style="min-width: 120px" alt="logo">
            </a>
            <!-- LOGO -->
            <!-- search start -->
...
{{--                            FACK CONTENT FOR ERROR HIDING--}}
                                <div class="message-menu" style="display: none!important;"></div>
                                <div class="notifications-menu" style="display: none!important;"></div>
                                <div class="cart-menu" style="display: none!important;"></div>
{{--                            FACK CONTENT END FOR ERROR HIDING--}}
...
{{--                            </div>--}}
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
												<span>
{{--													<img src="{{ asset('/') }}backend/assets/images/faces/6.jpg" alt="profile-user" class="avatar  profile-user brround cover-image">--}}
													<img src="https://png.pngtree.com/png-clipart/20210915/ourmid/pngtree-user-avatar-placeholder-black-png-image_3918427.jpg" alt="profile-user" class="avatar  profile-user brround cover-image">
												</span>
                                    <div class="text-center p-1 d-flex d-lg-none-max">
                                        <h6 class="mb-0" id="profile-heading">{{ auth()->check() ? auth()->user()->name : 'user' }}<i class="user-angle ms-1 fa fa-angle-down "></i></h6>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
