                    ...
                    <div class="swichermainleft text-center">
                        <div class="swichermainleft text-center">
                            <div class="p-3 d-grid gap-2">
                                <a href="{{ url('/') }}" class="btn ripple btn-primary mt-0" target="_blank">View Website</a>
                                <a href="{{ url('/') }}" class="btn ripple btn-secondary" target="_blank">View App</a>
                                <a href="{{ url('/dashboard') }}" class="btn ripple btn-pink" target="_blank">Admin Panel</a>
                            </div>
                        </div>
                    </div>
