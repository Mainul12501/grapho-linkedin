...
@section('title', 'Education Degree Name')
        ...
        <div class="col-md-6 mx-auto">
            <div class="card">
                <div class="card-header bg-warning">
                    <h4 class="text-white">Education Degree Name Create</h4>
                    <a href="{{ route('education-degree-names.index') }}" class="btn rounded-circle position-absolute end-0 me-3">
                        <i class="fa-regular fa-file-lines fa-2x text-white"></i>
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ isset($educationDegreeName) ? route('education-degree-names.update', $educationDegreeName->id) : route('education-degree-names.store') }}" method="post">
                        @csrf
