<div class="company-info mb-2">
    <a href="{{ route('employee.view-company-profile', $singleJobTask->employer_company_id) }}" style="cursor: pointer">
    ...
    <div class="company-details d-flex pt-2" style="padding-top: 14px;">
        <h3 class="p-t-5"><a href="{{ route('employee.view-company-profile', $singleJobTask->employer_company_id) }}" class="nav-link text-muted">{{ $singleJobTask?->employerCompany?->name ?? 'company name' }}</a></h3>
