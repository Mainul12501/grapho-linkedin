...
@push('style')
    <link rel="stylesheet" href="{{ asset('frontend/page-custom-codes/employer/company-profile/style.css') }}">
...
@push('script')
    ...
    <script src="{{ asset('frontend/page-custom-codes/employer/company-profile/script.js') }}"></script>
