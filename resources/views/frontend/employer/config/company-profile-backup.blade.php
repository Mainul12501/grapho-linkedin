                        ...
                        <div class=" companyProfilecontainer__right-part pb-4 pt-1 px-4">
                            <div class="mb-4">
                                <div id="short-overview">
                                    ...
                                    {!! str()->words($companyDetails->company_overview, 50, '<span id="show-full-btn" style="color: #FFCB11; cursor: pointer">  View all</span>') ?? strip_tags('<p class="f-s-30">Company Overview Not found</p>') !!}
                                </div>
