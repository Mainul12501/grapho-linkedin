...
<div class="d-flex employeHome">
    ...
    <nav class="bottom-nav employeMobileNav d-md-none border-top">
        ...
        <a href="{{ route('employer.dashboard') }}" class="nav-link text-center flex-fill {{ request()->is('employer/dashboard') ? 'active' : '' }}"><img src="{{ asset('/backend/assets/images/dashboard.png') }}" alt=""><br />{{ trans('home.dashboard') }}</a>
        ...
        <a href="{{ route('employer.my-job-wise-applicants') }}" class="nav-link text-center flex-fill {{ request()->is('employer/my-job-wise-applicants') ? 'active' : '' }}"><img src="{{ asset('/') }}frontend/employer/images/employersHome/Applicants.png" alt=""></i><br />{{ trans('employer.applicants') }}</a>
