<aside class="sidebar bg-white p-3">
    <a href="" class="brand mb-3 d-block">
        <img src="{{ isset($siteSetting) ? asset($siteSetting->logo) : asset('/frontend/employer/images/employersHome/logo.png') }}" alt="" class="" style="max-width: 60px; " /></a>
    <ul class="nav flex-column">
        <li class="nav-item mb-2" style="background-color: #FFCB11;">
        ...
        <li class="nav-item mb-2" style="background-color: #FFCB11;">
            <a class="nav-link {{ request()->is('employer/dashboard') ? 'active' : '' }}" href="{{ route('employer.dashboard') }}" ><img src="{{ asset('/backend/assets/images/dashboard.png') }}" alt="" style="height: 20px" class="me-2">{{ trans('employer.dashboard') }}</a>
        </li>
        <li class="nav-item mb-2" style="background-color: #FFCB11;">
        ...
        <li class="nav-item mb-2" style="background-color: #FFCB11;">
            <a class="nav-link {{ request()->is('employer/my-job-wise-applicants') ? 'active' : '' }}" href="{{ route('employer.my-job-wise-applicants') }}"><img src="{{ asset('/') }}frontend/employer/images/employersHome/ApplicantsDesk.png" alt="" class="me-2">{{ trans('employer.applicants') }}</a>
        </li>
...
{{--        </li>--}}
        <li class="nav-item" style="background-color: #FFCB11;">
