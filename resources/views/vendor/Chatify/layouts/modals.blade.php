  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">Delete this conversation?</div>
              <div class="app-modal-body">This will only delete the conversation for you. The other person will still be able to see it.</div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">Cancel</a>
                  <a href="javascript:void(0)" class="app-btn a-btn-danger delete">Delete for Me</a>
              </div>
          </div>
      </div>
  </div>
